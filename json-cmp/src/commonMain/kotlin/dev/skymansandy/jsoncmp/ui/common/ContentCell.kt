...
import dev.skymansandy.jsoncmp.ui.preview.previewFoldableLine
import dev.skymansandy.jsoncmp.ui.preview.previewLine
import dev.skymansandy.jsoncmp.ui.theme.JsonCmpColors
import dev.skymansandy.jsoncmp.ui.theme.monoStyle
import dev.skymansandy.jsoncmp.ui.theme.partColor
...
internal fun ContentCell(
    ...
    if (isFolded && line.foldId != null) {
        ...
        // Expanded: render all parts with syntax colours and optional search highlights
