...
- **JSON Viewer** — Read-only, syntax-highlighted, foldable JSON tree with virtualized rendering
- **JSON Editor** — Editable JSON with real-time validation, formatting, and sorting (50 KB limit)
